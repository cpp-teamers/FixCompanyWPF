    ...
    public class ConversationMessagesViewModel
    {
        ...
        public List<ChatListItems> ChatListItems
        {
            get
            {
                ...
                {
                    new ChatListItems() { ContactName = "User 1", LastMessageTime = "10:30 PM", Availability = "Online", IsRead=true, Message="Check out new video uploaded just now!", NewMsgCount="5", IsOnline=true},
        ...
        public List<ConversationMessages> Messages
        {
            get
            {
                return new List<ConversationMessages>
                {
                    ...
                    new ConversationMessages() { Message="Oh, hello! All perfectly.", MessageStatus="Sent", TimeStamp="Yesterday 14:38 PM"},
                    new ConversationMessages() { Message="01:24", MessageStatus="Received", TimeStamp="Yesterday 19:26 PM"},
